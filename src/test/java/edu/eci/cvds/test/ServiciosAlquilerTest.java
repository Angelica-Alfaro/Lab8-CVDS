...
public class ServiciosAlquilerTest {
    ...
    public void registrarAlquilerClienteInvalidoTest() {
    	try{
        	...
        	Assert.assertEquals("Error al registrar el itemItem{tipo=TipoItem{id=100, descripcion=Drama}, id=2026, nombre=Si decido quedarme, tarifaxDia=5000}",e.getMessage());
        }
    }
